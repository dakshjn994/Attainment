...
public partial class Mailreg : System.Web.UI.Page
{
    ...
    protected void email_ServerClick(object sender, EventArgs e)
    {
        try
        {
            ...
            cmd.CommandText = "Update Login Set Name=@n,Password=@pass Where UserId=@u And Email=@p";
            ...
            cmd.Parameters.AddWithValue("@n", name.Value.TrimEnd());
